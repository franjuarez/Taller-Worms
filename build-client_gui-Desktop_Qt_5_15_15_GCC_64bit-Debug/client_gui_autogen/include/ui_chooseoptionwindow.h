...
public:
    ...
    void setupUi(QDialog *ChooseOptionWindow)
    {
        ...
        ChooseOptionWindow->resize(1027, 484);
...
""));
        ...
        createButton->setGeometry(QRect(0, 320, 158, 31));
        QFont font;
...
"  border: none;"));
        ...
        createButton_2->setGeometry(QRect(0, 394, 158, 31));
...
"  border: none;"));
        ...
        joinButton->setGeometry(QRect(0, 431, 158, 31));
...
"  border: none;"));
        ...
        joinButton_2->setGeometry(QRect(0, 357, 158, 31));
