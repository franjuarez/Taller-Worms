...
QT.gui_private.enabled_features = xkbcommon xkbcommon-x11 xcb accessibility-atspi-bridge drm_atomic egl egl_x11 eglfs kms eglfs_egldevice xlib xcb-xlib eglfs_x11 evdev freetype system-freetype fontconfig gif harfbuzz ico imageio-text-loading jpeg linuxfb multiprocess png raster-64bit tuiotouch vkgen vnc xcb-egl-plugin xcb-glx-plugin xcb-glx
